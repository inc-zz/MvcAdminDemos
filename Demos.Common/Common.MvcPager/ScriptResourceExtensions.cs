...
//#else
            ...
            html.ViewContext.Writer.Write("<script type=\"text/javascript\">function _ajax_goBtn() {var pager = Webdiyer.MvcPagers[0]; if (pager != null) {pager.goToPage($('#pagebox').val());} else {alert('找不到指定的MvcPager！');}}</script>");
//#endif
        }
