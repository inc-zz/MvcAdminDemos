...
namespace TZ.Modules.PTS.Services
{
    public class TestCodes
    {
        ...
        public  List<DbTable> GetDbTables(string connectionString, string database, string tables)
        {
            ...
            {
                connectionString = "Data Source=192.168.1.137;Initial Catalog=TZWL_PTS2_dev;Persist Security Info=True;User ID=sa;Password=123456;";
                database = "TZWL_PTS2_dev";
                tables = "EMS_HEAD_INPUT";
            }
            ...
            {
                tables = string.Format(" and obj.name in ('EMS_HEAD_INPUT')");
            }
